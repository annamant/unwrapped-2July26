...
| Phase | Focus | Count |
|-------|--------|-------|
| **1** | South London (shoot first) | #01–12 |
| **2** | East London | #13–24 |
| **3** | North London | #25–34 |
| **4** | West & South-West | #35–46 |
| **5** | Central pockets (sparingly) | #47–52 |

**Default next episode:** first `queued` street in Phase 1 → **#01 Rye Lane, Peckham**.  
Suggested openers: Rye Lane → Electric Avenue → Lordship Lane → Clapham High Street.

Update status in `STREET_BACKLOG.md` when photos arrive or an episode posts.
