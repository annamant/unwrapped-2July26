...
Living calendar. The CMO agent updates this every run. Status: `idea` → `drafting` → `ready` → `scheduled` → `posted`.

| Date | Time (London) | Pillar | Format | Hook / working title | Asset | Status | Notes |
|------|---------------|--------|--------|----------------------|-------|--------|-------|
| 2026-07-25 | 11:02 | Launch | Feed 1:1 | "Unwrapped is live." | `marketing/instagram/drafts/2026-07-24/1_Limited-Local-Gone-when-theyre-gone.png` | posted | Original visible launch poster on @shopunwrapped |
...
| Date | Hook | Link / ID | Notes |
|------|------|-----------|-------|
| 2026-07-25 | Unwrapped is live | @shopunwrapped | Original visible launch poster. Caption drives to shopunwrapped.com/instagram |
...
- Neighbourhood series (one area per week)
- Business apply soft CTA Friday — "List a drop. Fill a quiet hour."
- Ending-soon story template when a real drop is live `[VERIFY]`
- Shop spotlight series (after first partner drops)
