# Instagram — Unwrapped (@shopunwrapped)

**Start here** for any agent working on Unwrapped Instagram.

**Grid:** empty (full wipe). Do not restage Jul/Aug typographic launch posts.

## Primary content strategy (until live drops dominate)

**Series: [London High Streets](./LONDON_HIGH_STREETS.md)** — one street per episode on the grid.
...
| File | Purpose |
|------|---------|
| [CONTENT_CALENDAR.md](./CONTENT_CALENDAR.md) | Living schedule · empty-grid status |
| [drafts/](./drafts/) | Per-episode folders (`YYYY-MM-DD-[street-slug]/`) |
| `.cursor/skills/unwrapped-cmo/SKILL.md` | CMO identity + production loop |
...
| Ask | URL |
|-----|-----|
| Nominate a shop | `shopunwrapped.com/recommend` |
| Business apply | `shopunwrapped.com/business-apply` |
| Shop / link in bio | `shopunwrapped.com/instagram` |
