    ...
    items: [
      {
        ...
        href: "/kit/print/Unwrapped-Window-Poster-A4.pdf",
        preview: "/kit/print/Unwrapped-Window-Poster-A4.png",
        format: "PDF · A4",
      ...
      },
      {
        ...
        href: "/kit/print/Unwrapped-Window-Poster-A4.png",
        preview: "/kit/print/Unwrapped-Window-Poster-A4.png",
        format: "PNG",
    ...
    items: [
      {
        ...
        href: "/kit/social/limited-local-gone.png",
        preview: "/kit/social/limited-local-gone.png",
        format: "PNG · 1:1",
      },
      {
        title: "How it works",
        description: "Reserve → QR → collect, in one frame.",
        href: "/kit/social/how-it-works-square.png",
        preview: "/kit/social/how-it-works-square.png",
        format: "PNG · 1:1",
      },
      {
        title: "Moments, not discounts",
        description: "Editorial line for neighbourhood culture posts.",
        href: "/kit/social/moments-not-discounts.png",
        preview: "/kit/social/moments-not-discounts.png",
        format: "PNG · 1:1",
      },
      {
        title: "Carousel 01 — Limited local drops",
        description: "Slide 1 of the launch explainer carousel.",
        href: "/kit/social/01-limited-local-drops.png",
        preview: "/kit/social/01-limited-local-drops.png",
        format: "PNG",
      },
      {
        title: "Carousel 02 — What is a drop",
        description: "Slide 2 of the launch explainer carousel.",
        href: "/kit/social/02-what-is-a-drop.png",
        preview: "/kit/social/02-what-is-a-drop.png",
        format: "PNG",
      },
      {
        title: "Carousel 03 — How it works",
        description: "Slide 3 of the launch explainer carousel.",
        href: "/kit/social/03-how-it-works.png",
        preview: "/kit/social/03-how-it-works.png",
        format: "PNG",
      },
      {
        title: "Carousel 04 — Not delivery",
        description: "Slide 4 of the launch explainer carousel.",
        href: "/kit/social/04-not-delivery.png",
        preview: "/kit/social/04-not-delivery.png",
        format: "PNG",
      },
      {
        title: "Carousel 05 — Start here",
        description: "Slide 5 of the launch explainer carousel.",
        href: "/kit/social/05-start-here.png",
        preview: "/kit/social/05-start-here.png",
        format: "PNG",
      },
    ],
  },
    ...
    items: [
      {
        ...
        href: "/kit/brand/logo-mark.svg",
        preview: "/kit/brand/logo-mark.svg",
        format: "SVG",
      },
      {
        title: "Logo lockup",
        description: "Mark + wordmark side by side.",
        href: "/kit/brand/logo-lockup-horizontal.svg",
        preview: "/kit/brand/logo-lockup-horizontal.svg",
        format: "SVG",
      },
      {
        title: "Wordmark",
        description: "“Unwrapped” text only.",
        href: "/kit/brand/logo-wordmark.svg",
        preview: "/kit/brand/logo-wordmark.svg",
        format: "SVG",
      },
      {
        title: "Share card",
        description: "Open Graph / link preview image for social and messaging.",
        href: "/kit/brand/Unwrapped-share-card.png",
        preview: "/kit/brand/Unwrapped-share-card.png",
        format: "PNG · 1200×630",
      },
    ],
  },
