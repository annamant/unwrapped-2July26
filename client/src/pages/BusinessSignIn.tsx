    ...
    <div style={{ minHeight: "100vh", display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1fr 1fr" }}>
      <div style={{ background: "#160703", display: "flex", flexDirection: "column", justifyContent: "space-between", padding: isMobile ? 24 : 48, gap: isMobile ? 20 : 0 }}>
        ...
        <div>
          ...
          <h1 style={{ fontFamily: "'Playfair Display', serif", fontSize: isMobile ? 28 : "clamp(36px, 4vw, 56px)", fontWeight: 700, color: "#FFF0F4", lineHeight: 1.1, letterSpacing: "-1px", marginBottom: isMobile ? 12 : 24 }}>
            Create a drop.<br />
        ...
        <div style={{ display: "flex", gap: isMobile ? 24 : 32, flexWrap: "wrap" }}>
          {[["You set", "Your payout"], ["0", "Monthly fees"], ["2 min", "To publish"]].map(([val, label]) => (
            <div key={label}>
              <div style={{ fontFamily: "'Playfair Display', serif", fontSize: 28, fontWeight: 700, color: "#FFF0F4" }}>{val}</div>
