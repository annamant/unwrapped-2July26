...
export default function ResetPassword() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#FFF8F4", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "40px 20px" }}>
      <div style={{ width: "100%", maxWidth: 380 }}>
        <a href="/" style={{ fontFamily: "'Playfair Display', serif", fontSize: 22, fontWeight: 700, color: "#9E1C0E", textDecoration: "none" }}>
          Unwrapped
        </a>
...
function RequestReset() {
  ...
  if (sent) {
    return (
      <div>
        <h1 style={{ fontFamily: "'Playfair Display', serif", fontSize: 28, fontWeight: 700, marginBottom: 12, color: "#9E1C0E" }}>Check your inbox</h1>
  ...
  return (
    <div>
      <h1 style={{ fontFamily: "'Playfair Display', serif", fontSize: 28, fontWeight: 700, marginBottom: 8, color: "#9E1C0E" }}>Reset your password</h1>
      ...
      <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 14, color: "#ABABAB", marginTop: 24, textAlign: "center" }}>
        Remembered it? <a href="/signin" style={{ color: "#9E1C0E", fontWeight: 500, textDecoration: "none" }}>Sign in →</a>
      </p>
    </div>
  );
}
...
function SetNewPassword({ token }: { token: string }) {
  ...
  if (done) {
    return (
      <div>
        <h1 style={{ fontFamily: "'Playfair Display', serif", fontSize: 28, fontWeight: 700, marginBottom: 12, color: "#9E1C0E" }}>Password updated</h1>
  ...
  return (
    <div>
      <h1 style={{ fontFamily: "'Playfair Display', serif", fontSize: 28, fontWeight: 700, marginBottom: 8, color: "#9E1C0E" }}>Choose a new password</h1>
      <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 15, color: "#888", marginBottom: 28, lineHeight: 1.5 }}>
